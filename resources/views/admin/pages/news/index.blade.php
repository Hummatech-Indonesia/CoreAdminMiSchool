        ...
        <div class="row align-items-center">
            <div class="col-9">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a class="text-muted text-white text-decoration-none" href="javascript:void(0)">Daftar - daftar berita Mischool.id</a>
                        </li>
                    </ol>
                </nav>
            </div>
...
<div class="d-flex flex-wrap justify-content-between align-items-center">
    ...
    <div class="col-12 col-md-auto mb-3">
        <button type="button" class="btn mb-1 btn-primary btn-lg px-4 fs-4 font-medium" data-bs-toggle="modal" data-bs-target="#modal-import">
            Tambah Berita
        </button>
    </div>
</div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn mb-1 btn-warning btn-sm fs-2 font-medium btn-edit" data-id="{{ $news->id }}" data-title="{{ $news->title }}" data-news_category_id="{{ $news->news_category_id }}" data-image="{{ asset('storage/'. $news->image) }}" data-description="{{ $news->description }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                            <g fill="none">
                    ...
                    <button type="button" class="btn mb-1 btn-danger btn-sm fs-2 font-medium" data-bs-toggle="modal" data-bs-target="#modal-edit">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
