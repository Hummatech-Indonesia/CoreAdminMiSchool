            ...
            <div class="col-lg-8">
                ...
                <div class="blog_left_side">
                    <div class="blog_panel" data-aos="fade-up" data-aos-duration="1500">
                        <div class="main_img">
                            <a href="/news-detail"><img src="{{ asset('storage/'. $latest->image) }}" class="w-100" style="height: 405px; object-fit:cover;" alt="image"></a>
                        </div>
                        <div class="blog_info">
                            <span class="date">{{ \Carbon\Carbon::parse($latest->date)->locale('id_ID')->isoFormat('D MMMM Y') }}</span>
                            <h2><a href="/news-detail">{{ Str::limit($latest->title, 200) }}</a></h2>
                            ...
                            <a href="/news-detail">
                                <div class="custom_d-flex flex-column flex-md-row d-flex">
                                    <div class="custom_img">
                                        <img src="{{ asset('storage/'. $otherNew->image) }}" style="width:155px; height:145px; object-fit: cover;" alt="image" class="img-fluid" />
                                    </div>
                                    <div class="custom_text mt-3 mt-md-0 ms-md-3">
                                        <span class="text-muted" style="font-size: 12px;">{{ \Carbon\Carbon::parse($otherNew->date)->locale('id_ID')->isoFormat('D MMMM Y') }}</span>
                ...
                <div class="blog_right_side">
                        ...
                        <ul class="recent_blog_list">
                            ...
                            <li>
                                <a href="blog-detail.html">
                                    <div class="img">
                                        <img src="{{ asset('storage/'. $recentPost->image) }}" style="width: 75px; height: 75px; object-fit:cover;" alt="image">
                                    </div>
                                    <div class="text">
                                        <h4>{{ Str::limit($recentPost->title, 45) }}</h4>
                                        <span>{{ \Carbon\Carbon::parse($recentPost->date)->diffForHumans() }}</span>
                                    </div>
                                </a>
                            </li>
                            @empty
                    ...
                    <div class="categories_block bg_box" data-aos="fade-up" data-aos-duration="1500">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{ route('news-category.index') }}" class="cat"><i class="icofont-folder-open"></i>{{ $category->name }}</a>
